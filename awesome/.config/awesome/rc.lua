...
run_once({"unclutter", "picom -b", "nm-applet" }) -- entries must be separated by commas
...
globalkeys = my_table.join(
	...
	awful.key({modkey}, "F2",		  function () awful.spawn.with_shell('scroll') end),
  ...
  {description = "take a screenshot of current window", group = "hotkeys"}),
	...
	awful.key({modkey, "Shift"	  }, "w", function()	awful.spawn('brave --incognito') end),
